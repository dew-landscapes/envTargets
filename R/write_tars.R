...
#' the store directory). Optionally exports a .csv of package versions based on
...
#' scripts.
#'
#' @return `NULL`. Two `_targets.yaml` files written. Optionally,
#' `package_info.csv` written.
#' @export
#'
#' @examples
